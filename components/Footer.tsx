...
import { Mail, MapPin, Phone, Facebook, Twitter, Instagram, ArrowUpRight } from 'lucide-react';
    ...
    <footer id="contact" className="bg-slate-950 text-slate-400 pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mb-20">
          <div className="reveal">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-12 h-12 rounded-2xl bg-slate-900 flex items-center justify-center hover:bg-[#0057B7] hover:text-white transition-all"><Facebook className="w-6 h-6" /></a>
              <a href="#" className="w-12 h-12 rounded-2xl bg-slate-900 flex items-center justify-center hover:bg-[#0057B7] hover:text-white transition-all"><Twitter className="w-6 h-6" /></a>
              <a href="#" className="w-12 h-12 rounded-2xl bg-slate-900 flex items-center justify-center hover:bg-[#0057B7] hover:text-white transition-all"><Instagram className="w-6 h-6" /></a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 reveal">
            ...
            <div>
              <h4 className="text-white font-bold text-xl mb-8 uppercase tracking-widest text-sm">Working Hours</h4>
              <ul className="space-y-4">
                <li className="flex justify-between items-center py-2 border-b border-slate-900">
                  <span className="font-medium">Monday - Friday</span>
                  <span className="text-white font-bold">8:00 - 17:00</span>
                </li>
                <li className="flex justify-between items-center py-2 border-b border-slate-900">
                  <span className="font-medium">Saturday</span>
                  <span className="text-white font-bold">8:00 - 12:00</span>
                </li>
                <li className="flex justify-between items-center py-2">
                  <span className="font-medium">Sunday</span>
                  <span className="text-rose-500 font-bold uppercase tracking-wide">Closed</span>
                </li>
                <li className="mt-8 bg-[#0057B7]/10 p-4 rounded-xl border border-[#0057B7]/20 text-sm">
                  <p className="text-[#0057B7] font-bold mb-1 italic underline">Emergency Notice:</p>
                  Urgent walk-ins accepted during regular operating hours. Call ahead if possible.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center space-x-8 text-sm uppercase tracking-widest font-bold">
